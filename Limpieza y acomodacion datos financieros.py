...
ecopetrol_df = pd.read_excel(
    "Ecopetrol 2013-2019 raw data.xls")  # Importar datos financieros como Dataframe, (previamente convertidos de
...
df_p_cierre = pd.DataFrame(ecopetrol_df['close'], columns=['close'])

# Graficar serie

"""plt.plot(serie_p_cierre.index, serie_p_cierre)
plt.show()"""
